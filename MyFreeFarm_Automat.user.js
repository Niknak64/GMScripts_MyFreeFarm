...
var botArbiter=new function(){
    ...
    try{
        ...
        switch(event){
            ...
            case "vehicles3":               
            case "vehicles4":               
            case "vehicles5":               priority=  5;fkt=autoVehicles;          break;
